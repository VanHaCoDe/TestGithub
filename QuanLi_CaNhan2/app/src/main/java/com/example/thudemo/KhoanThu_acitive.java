...
public class KhoanThu_acitive extends Activity {
    ...
    Button bttdate, bttthemkt, bt_clearkt;
    ImageButton imgbt_back;
    ListView listviekt;
    EditText editdate1, editsotien, edittkt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bttdate = (Button) findViewById(R.id.bt_datekt);
        bttthemkt = (Button) findViewById(R.id.bt_themkt);
        bt_clearkt = (Button) findViewById(R.id.bt_clearkt);
        imgbt_back = (ImageButton) findViewById(R.id.imgbt_backkt);
        editdate1 = (EditText) findViewById(R.id.editdatekt);
        editsotien = (EditText) findViewById(R.id.editsotienkt);
        edittkt = (EditText) findViewById(R.id.et_tkt);
        listviekt = (ListView) findViewById(R.id.listVkt);
        db = new DataAdapter(KhoanThu_acitive.this);
        db.open();

        loadTabs();

        bttthemkt.setEnabled(false);
        edittkt.addTextChangedListener(new TextWatcher() {
            @Override
        ...
        bttthemkt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String tkt = edittkt.getText().toString();
                int st = Integer.parseInt(editsotien.getText().toString());
                String nc = editdate1.getText().toString();
                db.insertkhoanthu(tkt, st, nc);
                Toast.makeText(KhoanThu_acitive.this, "Thêm Thành Công Tên: " + tkt, Toast.LENGTH_LONG).show();
                disAllKT();
                editsotien.setText(null);
                edittkt.setText(null);
                editdate1.setText(null);
            }
        });
        bt_clearkt.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                editsotien.setText(null);
                edittkt.setText(null);
        ...
        imgbt_back.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(KhoanThu_acitive.this, MainActivity2.class);
                startActivity(intent);
            }
        });

        Cursor curs = db.getAllkt();
        ...
        SimpleCursorAdapter cursordata = new SimpleCursorAdapter(this, R.layout.row_khoanthu, curs, from, to);
        ...
        try {
            ...
            listviekt.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View arg1, int position, long arg3) {
                    ...
                    stkt.setInputType(InputType.TYPE_CLASS_NUMBER);
                    ...
                    LayoutParams tenkt_layoupa = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
                    LayoutParams stkt_layoupa = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
                    LayoutParams nt_layoupa = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
    ...
    public void loadTabs() {
        ...
        spec.setIndicator("Thêm Khoản Thu");
        tab.addTab(spec);
        // T?o tab2
        spec = tab.newTabSpec("t2");
        spec.setContent(R.id.tab2kt);
        spec.setIndicator("Danh Sách Khoản Thu");
        tab.addTab(spec);
